 ...
 * @param {!Array.<string>} commandToolbox The available commands.
 * @param {!Array.<string>} conditionToolbox The available conditionals.
...
cn.LevelData = function(
    botPosition, stars, functions, commandToolbox, conditionToolbox, initial, goal, hint) {
  /** @type {number} */
  ...
  /** @type {!Array.<string>} */
  this.conditionToolbox = conditionToolbox;
